...
const Leaderboard = () => {
    ...
    useEffect(() => {
        const loadBlockchainData = async () => {
            ...
            const battleContract = new web3.eth.Contract(abi, "0xDc64a140Aa3E981100a9becA4E685f962f0cF6C9"); // Replace "YourContractAddress" with your deployed contract address
